...
<body>
    <?php
        ...
        // Save the generated result as a JSON file named "output.json"
        ...
        echo '<div class="container-fluid">
            <div class="row">'; 
                foreach ($result as $value) {
                    ...
                    // Check the value and assign colour for each card.
                    if ($value === "BIGBANG") {
                    ...
                    // Display the card with the assigned class and the value.
                    echo '
                    <div class="col-md-2">
